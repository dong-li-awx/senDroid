...
public class CameraListActivity extends AppCompatActivity implements CameraListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_app_bar);
    ...
    public void onItemSelected(String id) {
        Intent detailIntent = new Intent(this, CameraUsageActivity.class);
        detailIntent.putExtra(CameraUsageFragment.ARG_ITEM_ID, id);
